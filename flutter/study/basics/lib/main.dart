...
///下面是一个名为 的无状态小部件子类的骨架GreenFrog。
///通常，小部件有更多的构造函数参数，每个参数对应一个final属性。
class GreeFrog extends StatelessWidget {
  const GreeFrog({Key? key}) : super(key: key);
...
///下一个示例显示了更通用的小部件Frog，它可以被赋予颜色和子元素：
